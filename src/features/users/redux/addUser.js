...
export function addUser(args = {}) {
  return dispatch => {
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      const doRequest = axios.post(`${process.env.REACT_APP_API_URL}/users`, args);
...
export function reducer(state, action) {
  switch (action.type) {
    ...
    case USERS_ADD_USER_DISMISS_ERROR:
